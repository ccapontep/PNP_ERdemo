...
#include <er_action_msgs/TurnAction.h>
...
protected:
    ...
    actionlib::SimpleActionServer<er_action_msgs::TurnAction> turn_server;
...
public:
    ...
    void executeCB(const er_action_msgs::TurnGoalConstPtr& goal)  {
...
void turn_action_client(std::string robotname, double GTh, std::string absrel) {
    ...
    actionlib::SimpleActionClient<er_action_msgs::TurnAction> ac(turn_topic, true);
